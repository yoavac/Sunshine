...
import com.example.yoav.mynewsunshine.data.WeatherContract.WeatherEntry;
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            final String FORECAST_BASE_URL =
                   // http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7&APPID=3907defc26c7aab3fe639bece3d2140c
